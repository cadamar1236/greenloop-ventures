...
const carbonOffsets = [
  ...
  { id: 'co-5', name: 'Community Cookstoves', price: '$32/ton', rating: 4.4, reviews: 234, type: 'Social', image: '🔥', description: 'Efficient cookstove distribution reducing deforestation and improving health.', projects: 'Clean Cookstoves East Africa', vintage: '2024', standard: 'Gold Standard' },
...
const impactStats = [
  { label: 'Suppliers Onboarded', value: '240+', icon: 'Building2', color: 'text-emerald-400' },
  { label: 'CO2 Offset (tons)', value: '52,000+', icon: 'TreePine', color: 'text-green-400' },
  { label: 'Active Buyers', value: '1,800+', icon: 'Users', color: 'text-blue-400' },
  { label: 'Avg. Sustainability Rating', value: '9.1/10', icon: 'Award', color: 'text-amber-400' },
]
